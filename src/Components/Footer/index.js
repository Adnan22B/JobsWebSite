...
export default function index() {
  return ( 
    <footer class="main-footer style-three" style={{backgroundImage: 'url(assets/images/background/3.png)'}} >
        ...
        <div class="row">
          <div class="big-column col-xl-3 col-lg-3 col-md-12">
            <div class="footer-column about-widget">
              <div class="logo"><a href="#"><img src="assets/images/logo-2.svg" alt=""/></a></div>
